...
export const SidePopupContainer = styled.div<StyleProps>`
    ...
    top: 0;
    left: 0;
    background-color: ${({ $bgColor }) => $bgColor || 'rgba(0,0,0, .3)'};
    transition: all .2s;
...
export const SideBarContainer = styled.div<StyleProps>`
    ...
    @media (max-width: 770px) {
        width: 20rem;
        left: ${({ $isSideBar }) => $isSideBar ? 0 : -20}rem;
        padding-top: 8rem;
    }
`
...
export const FixedPopup = styled.div<StyleProps>`
    width: ${({ $width, $sizeUnit }) => $sizeUnit && $width ? `${$width}${$sizeUnit}` : $width ? `${$width}rem` : '50rem'};
    height: ${({ $height, $hUnit }) => $hUnit && $height ? `${$height}${$hUnit}` : $height ? `${$height}rem` : '100%'};
    position: fixed;
    ...
    padding-top: ${({ $topPadding, $padding }) => $topPadding || $padding || 2.5}rem;
    padding-bottom: ${({ $bottomPadding, $padding }) => $bottomPadding || $padding || 2.5}rem;
    padding-left: ${({ $leftPadding, $padding }) => $leftPadding || $padding || 2.5}rem;
    padding-right: ${({ $rightPadding, $padding }) => $rightPadding || $padding || 2.5}rem;
...
export const FormGroup = styled.div<StyleProps>`
    ...
    input:focus, textarea:focus {
        border-color: #0D968F;
        box-shadow: 0 0 0 0.2rem #E4ECF7;
    }
`
...
export const Button = styled.button<StyleProps>`
    ...
    border: ${({ $borderColor }) => $borderColor ? `1px solid ${$borderColor}` : 'none'};
    transition: all .2s;
    font-size: ${({ $titleSize }) => $titleSize || 1.6}rem;
    ...
    &:hover, &:focus {
        ...
        color: ${({ $hoverColor, $color }) => $hoverColor ? $hoverColor : $color ? $color : '#111111'};
        outline: none
    }
`
export const OutlineButton = styled.button<StyleProps>`
    width: ${({ $width, $sizeUnit }) => $sizeUnit && $width ? `${$width}${$sizeUnit}` : $width ? `${$width}rem` : '20rem'};
    height: ${({ $height }) => $height || 4.5}rem;
    border: 1px solid ${({ $color }) => $color || '#0D968F'};
    border-radius: ${({ $radius }) => $radius || 0.8}rem;
    outline: none;
...
export const DataWithLabel = styled.div<StyleProps>`
    ...
    label {
        ...
        color: ${({ $titleColor }) => $titleColor || '#425466'};
...
export const AppLink = styled.a<StyleProps>`
    ...
    padding-right: ${({ $rightPadding }) => $rightPadding || 0}rem;
    text-align: ${({ $align }) => $align || 'left'};
    border-bottom: ${({ $hasBottomBorder, $color }) => $hasBottomBorder ? `1px solid ${$color || '#4C6FFF'}` : 'none'};
    outline: none;
    cursor: pointer;
    transition: all .2s;
    font-family: ${({ $fontFamily }) => $fontFamily && $fontFamily};
...
export const FixedContainer = styled.div<StyleProps>`
    ...
    background: ${({ $bgColor }) => $bgColor || 'transparent'};
    width: ${({ $width, $sizeUnit }) => $sizeUnit && $width ? `${$width}${$sizeUnit}` : $width ? `${$width}rem` : 'auto'};
    height: ${({ $height, $hUnit }) => $height === 'full' ? '100%' : $hUnit && $height ? `${$height}${$hUnit}` : $height ? `${$height}rem` : 'auto'};
    border-radius: ${({ $radius }) => $radius || 0}rem;
    z-index: ${({ $zIndex }) => $zIndex || 1};
    transition: all 0.2s;
    padding-top: ${({ $topPadding }) => $topPadding || 0}rem;
...
export const MenuIcon = styled(FiMenu) <StyleProps>`
    font-size: 3rem;
    position: fixed;
    color: rgba(0, 0, 0, 0.7);
    top: ${({ $isSideBar }) => $isSideBar ? '2rem' : '3.8rem'};
    left: ${({ $isSideBar }) => $isSideBar ? '2rem' : '1rem'};
    transition: all .2s;
    display: none;
    z-index: 6;
